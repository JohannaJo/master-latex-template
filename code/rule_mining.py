...
def rule_mining(kb=None, kb_filepath=None, miner_filepath="amie-milestone-intKB.jar", max_rule_body_size=2, save_raw_mining_output=False, save_mined_rules=False):
    """
...
#print(rule_mining(kb=family_subset, save_raw_mining_output=False, save_mined_rules=True))