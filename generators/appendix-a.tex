...
\begin{subfigure}{.5\textwidth}
  \centering
  \includesvg[width=1\linewidth]{figures/appendix/Extension_sizes_models_WN18RR.svg}
  \caption{WN18RR \gls{kg}.}
  \label{fig:model_extension_wn18rr_boxplot_sub}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includesvg[width=1\linewidth]{figures/appendix/Extension_sizes_models_family.svg}
