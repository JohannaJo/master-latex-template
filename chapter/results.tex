...
\end{subfigure}
\caption[Rules and their types over KG embedding models]{Distribution of rules over KG embedding models. Note that the bar for TransE extends far beyond the chart.}
