...
If we look at listing \ref{entity_selection_KG} as an example KG and need to select three entities for candidate generate, then with the 
\begin{itemize}
