...
We have used the PCA when generating and evaluating rules, which as we know is merely an approximation of the truth. Just because a single child of a mother is listed in Wikidata does not mean that this woman did not have more children, these missing children were perhaps just not as famous and thus not mentioned in the database.
